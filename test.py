...
class SystemeGestionFoule:
                ...
                if boxes is not None:
                    for box in boxes:
                        ...
                        if nom_classe == 'person' and conf > 0.4:
                            ...
                            if roi.shape[0] > 0 and roi.shape[1] > 0 and self.is_yellow(roi):
                                color = (0, 255, 255)
    ...
    def is_yellow(self, roi):
        # Convert ROI to HSV and check for yellow dominance
        ...
        return yellow_ratio > 0.15  # 15% of the box is yellow
